      ...
      <footer className="py-8 px-6 bg-black border-t border-white/10">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-white/40">
            <Link to="/festival/giggen-sessions" className="hover:text-white transition-colors">
              Festival
            </Link>
            <a href="mailto:hei@giggen.app" className="hover:text-white transition-colors">
              Kontakt
            </a>
          </div>
        </div>
