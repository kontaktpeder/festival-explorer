...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Fixed positioning with proper mobile constraints
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%]",
        // Max height to prevent overflow, with safe-area support
        "max-h-[calc(100dvh-2rem)] sm:max-h-[85vh]",
        // Styling
        "gap-4 border bg-background p-4 sm:p-6 shadow-lg duration-200 sm:rounded-lg",
        // Prevent body scroll when open and better scroll handling
