...
const TikTokIcon = () => <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
export function SocialSection() {
  return <section className="relative py-10 px-6 bg-black">
      {/* Content */}
      <div className="relative z-10 max-w-xl mx-auto text-center">
        ...
        <p className="mt-6 text-xs text-white/30">
          Vi er nyoppstartet - følg oss for oppdateringer         
        </p>
      </div>
    </section>;
}