...
BEGIN
  ...
  -- This prevents FK violations when asset_handles are later deleted
  ...
  -- Also clear rider asset references on program slots created via user's events
  ...
  -- Delete asset_handles created by this user
  WITH deleted AS (
