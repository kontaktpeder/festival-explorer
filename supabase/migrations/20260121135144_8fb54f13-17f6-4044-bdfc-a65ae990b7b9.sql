-- ============================================
-- RPC: delete_user_safely
-- Safely deletes a user while preserving shared projects
-- ============================================
...
BEGIN
  ...
  LOOP
    ...
    -- If still no one, entity stays with original creator (will be orphaned but preserved)
  ...
  LOOP
    -- For events, try to find an admin or any other team member from related entities
    -- Or just keep the event with a system transfer note
    -- For simplicity, we'll keep events but note they're orphaned
    -- In production, you might want to transfer to a platform admin
  ...
  -- ============================================
  -- 5. Delete entity_persona_bindings for user's personas
  -- (Will cascade when we delete personas)
  -- ============================================

  -- ============================================
  -- 6. Delete all personas owned by this user
  -- ============================================
  ...
  -- ============================================
  -- 7. Remove user from all entity teams
  -- ============================================
  WITH deleted AS (
